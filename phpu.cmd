...
IF /I "%1%"=="drop" (
    echo "dropping phpunit tests"
    %DOCKERDIR%/bin/moodle-docker-compose.cmd exec webserver php admin/tool/phpunit/cli/util.php --drop
    EXIT 0
)
...
%DOCKERDIR%/bin/moodle-docker-compose.cmd exec webserver vendor/bin/phpunit -c %1%
